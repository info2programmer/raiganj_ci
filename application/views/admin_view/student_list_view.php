    ...
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12">
        ...
        <div class="alert alert-success">
          <form class="form-horizontal" action="<?php echo base_url() ?>student" method= 'post'>
            <div class="form-group">
              <label class="control-label col-sm-2" for="txtStartDate">Start Date :</label>
              <div class="col-sm-10">
                <input type="date" class="form-control" id="txtStartDate" name="txtStartDate" autofocus required>
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-sm-2" for="txtEndDate">End Date :</label>
              <div class="col-sm-10">
                <input type="date" class="form-control" id="txtEndDate" name="txtEndDate" autofocus required>
              </div>
            </div>
