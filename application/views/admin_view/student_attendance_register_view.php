	...
	<div class="container">
		<div class="row">
			<div class="col-md-12 col-sm-12">
				<h4 class="alert alert-info">View Student Attendance Register </h4>
				<div class="alert alert-success">
					<form class="form-horizontal" action="<?php echo base_url() ?>student/attendance_report" method= 'post' target="_blank">
						...
						<div class="form-group">
							<label class="control-label col-sm-2" for="txt_print">Select If Page is Legal :</label>
							<div class="col-sm-10">
								<input type="radio" name="txt_print" id="txt_print" value="0" onclick="change_print_style()">
							</div>
						</div>
