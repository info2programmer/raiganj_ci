...
<body>
    <table width="650" border="0" cellspacing="0" cellpadding="0">
      <tbody><tr>
        ...
        <br>
        <span class="style2"><span class="style3">RECEIPT &amp; PAYMENT ACCOUNT FOR THE YEAR ENDED 31'ST MARCH 2017</span></span><br>
        <br>
        <table width="300" border="0" cellspacing="0" cellpadding="0" style="float:left;">
          <tbody><tr>
            <td width="225" height="18" align="left" valign="middle" class="style8">Receipt</td>
...
<table width="300" border="0" cellspacing="0" cellpadding="0" style="float:left; margin-right:15px;">
  <tbody><tr>
    <td width="225" height="18" align="left" valign="middle" class="style8">Payment</td>
    <td width="50" align="center" valign="middle" class="style8">Rs. P.</td>
</tr>
