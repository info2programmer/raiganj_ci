...
/*	header('Content-Type: application/vnd.xls');	//define header info for browser
  ...
  // echo "<script>alert('".$txtDate11."');</script>";
  // echo "<script>alert('".$txtDate22."');</script>";


 // $collected_by= $_SESSION['user']['username'];

	$sql = 'select * from td_fee_collection where year ="'.$year.'" and col_date between "'.$txtDate11.'" and "'.$txtDate22.'"';
  // echo $sql;
  // die;
        ...
        <td align="center" valign="middle"><br />
          ...
          <table width="1500" border="1" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse; border-top:2px solid #000000;">
            ...
            <?php $i=1; do {
              ...
              $row1=mysql_fetch_assoc(mysql_query("SELECT * FROM admission_erp WHERE form_no='".$exp[1]."'"));
             ...
             $row1=mysql_fetch_assoc(mysql_query("SELECT * FROM student_dtl WHERE form_no='".$exp[1]."'"));
            }

            $rowFee=mysql_fetch_assoc(mysql_query("SELECT * FROM `td_fee_subfunds` WHERE `fee_id`='".$row['fee_id']."'"));
            while($rowFee)
            {
              switch ($rowFee['fee_head_id']) {
                            case 1:
                              $tution_fee[]=$rowFee['amount'];
                              break;
                            case 2:
                              $admission_fee[]=$rowFee['amount'];
                            break;
                            case 3:
                               $development_fee[]=$rowFee['amount'];
                            break;
                            case 4:
                              $library_fee[]=$rowFee['amount'];
                              break;
                            case 5:
                              $clgexam_fee[]=$rowFee['amount'];
                            break;
                            case 6:
                              $electricity_fuel_fee[]=$rowFee['amount'];
                            break;
                            case 7:
                              $telephone_fee[]=$rowFee['amount'];
                            break;

                            case 8:
                              $comp_photocopy_fee[]=$rowFee['amount'];
                            break;

                            case 9:
                               $establishment_fee[]=$rowFee['amount'];
                            break;

                            case 10:
                              $laboratory_fee[]=$rowFee['amount'];
                            break;
                            ...
                            case 11:
                              $union_member_fee[]=$rowFee['amount'];
                            break;

                            case 12:
                              $cultural_fee[]=$rowFee['amount'];
                            break;

                            case 13:
                              $sports_game_fee[]=$rowFee['amount'];
                            break;

                            case 14:
                              $commonroom_fee[]=$rowFee['amount'];
                            break;

                            case 15:
                              $magazine_fee[]=$rowFee['amount'];
                            break;

                            case 16:
                              $registration_fee[]=$rowFee['amount'];
                            break;

                            case 17:
                              $student_aid_fee[]=$rowFee['amount'];
                            break;

                            case 18:
                              $comp_awar_fee[]=$rowFee['amount'];
                            break;

                            case 19:
                                $festival_fee[]=$rowFee['amount'];
                            break;

                            case 20:
                                $identitycard_fee[]=$rowFee['amount'];
                            break;

                            case 21:
                                $election[]=$rowFee['amount'];
                            break;

                            case 23:
                                $miscleneous_fee[]=$rowFee['amount'];
                            break;

                            case 24:
                                $form_postaget_fee[]=$rowFee['amount'];
                            break;

                            case 27:
                                $studenthealth_fee[]=$rowFee['amount'];
                            break;

                            case 30:
                                $application_fee[]=$rowFee['amount'];
                            break;

                            case 34:
                                $sports_fee[]=$rowFee['amount'];
                            break;
		  ...
		  ?>
            ...
            <td height="22" align="center" valign="middle" class="style11"><?php echo $row['rect_no'];?></td>
              ...
              {
               ?>
              <td width="28" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['admission_fee'];?><span>Admission Fee</span></a></td>
              <td width="28" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['tuition_fee'];?><span>Tuition Fee</span></a></td>
              <td width="26" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['develop_fee'];?><span>Development Fee</span></a></td>
              <td width="26" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['library_fee'];?><span>Library Fee</span></a></td>
              <td width="26" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['clgexam_fee'];?><span>College Exam Fee</span></a></td>
              <td width="26" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['electricity_fuel_fee'];?><span>Electricity Fuel Fee</span></a></td>
              <td width="26" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['telephone_fee'];?><span>Telephone Fee</span></a></td>
              <td width="26" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['comp_photocopy_fee'];?><span>Comp. Photocopy</span></a></td>
              <td width="26" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['establishment_fee'];?><span>Establishment Fee</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['laboratory_fee'];?><span> Laboratory Charge</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['union_member_fee'];?><span> Union Membership</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11">&nbsp;</td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['cultural_fee'];?><span>cultural Fee</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['sports_game_fee'];?><span>Sports Game Fee</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['common_room_fee'];?><span>Common Room Fee</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['magazine_fee'];?><span>Magazine Fee</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['registration_fee'];?><span>Registration Fee</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['student_aid_fee'];?><span>Student Aid Fee</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['studenthealth_fee'];?><span>Student Health Home</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['comp_awar_fee'];?><span>Comp. Aware Fee</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['festival_fee'];?><span>Festival Fee</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['i_card'];?><span>I Card Fee</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['election'];?><span>Election Fee</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['sports_fee'];?><span>Sports Fee</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['miscleneous_fee'];?><span>Miscleneous Charge</span></a></td>
              <td width="27" height="22" align="center" valign="middle" class="style11"><a class="tooltips" href="#"><?php echo $rowFee['form_postaget_fee'];?><span>Form Postage</span></a></td>
